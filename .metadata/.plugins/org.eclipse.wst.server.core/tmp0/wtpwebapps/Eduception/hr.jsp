...
<div class="title"><h2>HR Details</h2></div>
Welcome : <h:outputLabel value="#{controller.userBean.name}"></h:outputLabel>
<%
String HRhtmlFlush = session.getAttribute("HRhtmlFlush").toString();
%>
<%= HRhtmlFlush %>

	<div class="button">
		<h:commandButton action="#{controller.postJob}" value="Post Job"></h:commandButton>
	</div>
