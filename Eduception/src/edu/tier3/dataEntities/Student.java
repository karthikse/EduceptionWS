...
@NamedQueries({
	//@NamedQuery(name="Student.findByUserId", query="SELECT s FROM Student s where s.studentId = :userId")
	@NamedQuery(name="Student.findByUserId", query="SELECT s FROM Student s where s.user.uid = :userId")
})
